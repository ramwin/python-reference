.. python-reference documentation master file, created by
   sphinx-quickstart on Tue Mar 26 23:32:59 2024.
...
.. toctree::
   ...
   ./language_reference/global全局变量.md
   ./library_reference/argparse.md
   ./library_reference/asyncio.md
   ./library_reference/built_in_functions内置函数.md
   ./library_reference/built_in_types内置数据类型.md
   ./library_reference/csv.md
   ./library_reference/datetime时间.md
   ./library_reference/heapq.md
   ./library_reference/itertools.md
   ./library_reference/json.md
   ./library_reference/multiprocessing.md
   ...
   ./other_useful_library/beautifulsoup.md
   ./other_useful_library/click.md
   ./other_useful_library/flask.md
   ./other_useful_library/imapclient.md
   ...
   ./other_useful_library/wechatpy.md
